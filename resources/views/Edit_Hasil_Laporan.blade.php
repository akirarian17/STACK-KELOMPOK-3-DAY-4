        ...
        <div class="card mt-3 custom-card">
          ...
          <div class="card-body">
            <form action="/Edit_Laporan" method="POST">
              ...
              <div class="mb-3">
                <input value="{{$aspirasi['Judul']}}" name="Judul"
                  type="text"
                  class="form-control"
                  id="Judul"
              ...
              <div class="mb-3">
                ...
                > {{$aspirasi['Aspirasi']}} </textarea>
              </div>
              <div class="mb-3">
                <input value="{{$aspirasi['Nama']}}" name="Nama"
                  type="text"
                  class="form-control"
                  id="Nama"
              ...
              <div class="col-12">
                <label class="visually-hidden" for="inlineFormSelectPref"
                  >Preference</label
                >
                <select value="{{$aspirasi['Kategori']}}" name="Kategori" class="form-select" id="inlineFormSelectPref">

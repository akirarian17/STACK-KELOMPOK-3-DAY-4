      ...
      <div class="container">
        ...
        <div class="card mt-3 custom-card">
          ...
          <div class="card-body">
            ...
            <!-- button -->
            <div class="upload">
              <a href="Masuk.html" class="button-masuk">Masuk</a>
            </div>
            <div class="mb-3">
                Belum Memiliki Akun?
                <p> <a style="text-decoration:none" href="Daftar.html"> Daftar Sekarang </p>
            </div>
          </div>
        </div>
      </div>
...
<?php /**PATH C:\Coding\STACK\Stack_Real\resources\views/Masuk.blade.php ENDPATH**/ ?>
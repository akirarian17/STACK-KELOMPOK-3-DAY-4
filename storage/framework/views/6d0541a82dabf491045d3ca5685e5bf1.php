  ...
  <body>
    ...
    >
      <div class="container">
        ...
        <div>
          <a style="text-decoration:none" href="/Daftar"><button class="button-primary">Daftar</button>
          <a href="/Masuk" class="button-secondary">Masuk</a>
        </div>
      </div>
    </nav>
    <!-- End Navbar -->
...
<?php /**PATH C:\xampp\htdocs\Stack_Real 1.1\resources\views/Lafor.blade.php ENDPATH**/ ?>